...
#Objects (Server)
_OBJ_SERVER = cubeRunnerServer.o server.o client.o World.o Water.o \
...
#Headers (Server)
_HDR_SERVER = include.hpp using.hpp initColors.hpp Game.hpp World.hpp \
	   Water.hpp Obstacle.hpp Seaweed.hpp Coral.hpp Shark.hpp Octopus.hpp \
