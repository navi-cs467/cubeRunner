...
#define VERTICAL_SHOT_DIVISOR 6				//Controls the speed of the vertical shot. A bigger number is a faster shot.
#define HORIZONTAL_SHOT_DIVISOR 3			//Controls the speed of the horizontal shot. A bigger number is a faster shot.
